...
class MegatronCheckpointSaverLLM(MegatronCheckpointSaverBase):
    def import_model_provider(self):
        ...
        if self.md.model_type == 'GPT':
            ...
            self.model_provider = partial(model_provider, gpt_builder) #固定model_provider的参数model_builder为gpt_builder
    ...
    def receive_model(self):
        # Model schema. 获取参数名称映射，key是saver自定义的名字，value是GPTModel实际参数名，对GPT用了decoder名称
